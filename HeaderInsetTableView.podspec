#
#  Be sure to run `pod spec lint uuvpagescontroller.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Shin Chueng" => "zangxiaoxin@gmail.com" }
  # Or just: s.author    = "Shin Chueng"
  # s.authors            = { "Shin Chueng" => "zangxiaoxin@gmail.com" }
  # s.social_media_url   = ""
  ...
  s.source       = { :git => "https://github.com/SinCheung/HeaderInsetTableView.git", :tag => s.version.to_s }
